...
namespace skillsystemstudy
{
    public class Skill
    {
        ...
        public int LastUsedTime; // 마지막 사용 시간 (TickTime 기준)
        ...
        public void Use(ref int playerMana)
        {
            ...
            playerMana -= ManaCost; // 플레이어마나 참조로 외부 값도 같이 동기화
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine($"{i + 1}. {skills[i].Name} (MP : {skills[i].ManaCost}) (쿨다운 : {skills[i].CoolDown / 1000}초)");
                }
